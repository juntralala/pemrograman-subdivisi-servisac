...
if(isset($_POST['simpan'])){
    ...
    $simpan = mysqli_query($conn, "INSERT INTO tbl_user VALUES(NULL, '$nm_user', '$telp', '$password')");

    // apabila query diatas jalan maka arahkan ke halaman user
    if($simpan){
        header("Location: user.php");
    } else {
        // apabila query diatas gagal maka arahkan ke halaman user-tambah
        ...
        <div class="row">
            ...
            <div class="col-lg-9 bg-light">
                <div class="form">
                    ...
                    <p>Silahkan menambahkan data Data User baru pada Form dibawah ini</p>
                    <hr>
