...
if(isset($_POST['simpan'])){
    ...
    $simpan = mysqli_query($conn, "INSERT INTO tbl_jenis VALUES(NULL, '$nm_jenis')");

    // apabila query diatas jalan maka arahkan ke halaman jenis
    if($simpan){
        header("Location: jenis.php");
    } else {
        // apabila query diatas gagal maka arahkan ke halaman jenis-tambah
        ...
        <div class="row">
            ...
            <div class="col-lg-9 bg-light">
                <div class="form">
                    ...
                    <p>Silahkan menambahkan Data Jenis baru pada Form dibawah ini</p>
                    <hr>
                    <form method="post" class="mb-5">
                        <div class="mt-2">
                            <label for="nm_jenis">Nama :</label>
                            <input type="text" name="nm_jenis" id="nm_jenis" class="form-control" required>
                        </div>
                        <div class="mt-2">
